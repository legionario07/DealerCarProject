...
import br.com.dealercar.core.dao.AbstractPesquisaItensOpcionais;
 ...
 *
 */
public class CadeirinhaBebeDAO extends AbstractPesquisaItensOpcionais {
	...
	public void cadastrar(EntidadeDominio entidade) {
		...
		if(!(entidade instanceof CadeirinhaBebe))
			return;
		
		CadeirinhaBebe cadeirinha = new CadeirinhaBebe();
		cadeirinha = (CadeirinhaBebe) entidade;
	 ...
	 */
	@Override
	public CadeirinhaBebe pesquisarPorCodigo(EntidadeDominio entidade) {
		
		if(!(entidade instanceof CadeirinhaBebe))
			return null;
		
		CadeirinhaBebe cadeirinhaBebe = new CadeirinhaBebe();
		cadeirinhaBebe = (CadeirinhaBebe) entidade;
	...
	@Override
	public CadeirinhaBebe pesquisarPorID(EntidadeDominio entidade) {
