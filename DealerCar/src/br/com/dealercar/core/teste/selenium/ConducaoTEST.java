...
import br.com.dealercar.core.teste.selenium.LoginTEST;
import br.com.dealercar.core.teste.selenium.TEST;
...
public class ConducaoTEST extends TEST {
	...
	public void executarConducao() {
		...
		driver.navigate().refresh();
		driver.get("http://localhost:8080/DealerCar/faces/pages/pesqdevcpf.html");
	...
	public static void clickButton(By element) {
		wait = new WebDriverWait(driver, 1000); // espera por dez sengundos
